# [1410. HTML Entity Parser](https://leetcode.cn/problems/html-entity-parser/description/)

<div><div class="elfjS" data-track-load="description_content"><p><strong>HTML entity parser</strong> is the parser that takes HTML code as input and replace all the entities of the special characters by the characters itself.</p>
