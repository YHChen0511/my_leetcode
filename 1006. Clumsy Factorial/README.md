# [1006. Clumsy Factorial](https://leetcode.cn/problems/clumsy-factorial/description/)

<div><div class="elfjS" data-track-load="description_content"><p>The <strong>factorial</strong> of a positive integer <code>n</code> is the product of all positive integers less than or equal to <code>n</code>.</p>
