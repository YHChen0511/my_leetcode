# [2451. Odd String Difference](https://leetcode.cn/problems/odd-string-difference/description/)

<div><div class="elfjS" data-track-load="description_content"><p>You are given an array of equal-length strings <code>words</code>. Assume that the length of each string is <code>n</code>.</p>
